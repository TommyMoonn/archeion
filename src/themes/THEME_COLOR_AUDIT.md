...
- Direct built-in palette duplication in reader chrome and swatches is an intentional pre-runtime bootstrap; the runtime reader palette adapter replaces reader chrome variables and owns EPUB content colors.
