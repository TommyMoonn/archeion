...
const APP_CONTRAST_PAIRS: readonly AppContrastPair[] = Object.freeze([
  ...
  { foreground: "focus", background: "canvas", minimumRatio: 3 },
  { foreground: "focus", background: "canvasDeep", minimumRatio: 3 },
  { foreground: "focus", background: "surface", minimumRatio: 3 },
  { foreground: "focus", background: "surfaceRaised", minimumRatio: 3 },
  { foreground: "focus", background: "surfaceHover", minimumRatio: 3 },
  { foreground: "focus", background: "frame", minimumRatio: 3 },
  { foreground: "focus", background: "sidebar", minimumRatio: 3 },
  { foreground: "focus", background: "main", minimumRatio: 3 },
  { foreground: "focus", background: "mainRaised", minimumRatio: 3 },
...
const READER_CONTRAST_PAIRS: readonly ReaderContrastPair[] = Object.freeze([
  ...
  { foreground: "focus", background: "surface", minimumRatio: 3 },
  { foreground: "focus", background: "codeBackground", minimumRatio: 3 },
